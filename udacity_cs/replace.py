...
###
# 1. find first position of marker
# 2. replace marker with replacement
# 3. concatenate sentence after replacement

mark = line.find(marker)
print mark
replaced = line[0: mark] + replacement + line[mark + len(marker) :]
print replaced
